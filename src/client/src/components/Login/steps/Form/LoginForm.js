            ...
            >
              <div className="login__message">
                <InfoMessage>
                  ...
                  Vous pouvez désormais vous connecter en utilisant votre
                  adresse mail au format :{" "}
                  <strong>prenom.nom@departement.gouv.fr</strong>
                </InfoMessage>
                  ...
                  <div className="control">
                    <Button
                      ...
                      buttonClasses={classNames("login__button", {
                        "is-disabled": isDisabledEmailSubmit,
                        "is-loading": loading,
