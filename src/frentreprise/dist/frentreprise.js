...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../Utils/utils */ \"./src/Utils/utils.js\");\n/* harmony import */ var _Helpers_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/helpers */ \"./src/DataSources/SireneAPI/Helpers/helpers.js\");\n\n\n\nconst getEntreprise = async (SIREN, Axios, params, db) => {\n  return await _Utils_utils__WEBPACK_IMPORTED_MODULE_0__[\"default\"].requestAPI(Axios, `siren/${SIREN}`, params).then(async data => {\n    if (!data.uniteLegale) {\n      return {};\n    }\n\n    return await _Helpers_helpers__WEBPACK_IMPORTED_MODULE_1__[\"default\"].formatEnt(data.uniteLegale, params, db);\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (getEntreprise);\n\n//# sourceURL=webpack://frentreprise/./src/DataSources/SireneAPI/Siren/getEntreprise.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _getEntreprise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getEntreprise */ \"./src/DataSources/SireneAPI/Siren/getEntreprise.js\");\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  getEntreprise: _getEntreprise__WEBPACK_IMPORTED_MODULE_0__[\"default\"]\n});\n\n//# sourceURL=webpack://frentreprise/./src/DataSources/SireneAPI/Siren/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"_\", function() { return _; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return SireneAPI; });\n/* harmony import */ var tunnel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tunnel */ \"tunnel\");\n/* harmony import */ var tunnel__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(tunnel__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _DataSource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../DataSource */ \"./src/DataSources/DataSource.js\");\n/* harmony import */ var _Siren__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Siren */ \"./src/DataSources/SireneAPI/Siren/index.js\");\n/* harmony import */ var _Siret__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Siret */ \"./src/DataSources/SireneAPI/Siret/index.js\");\n/* harmony import */ var _lib_axios__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../lib/axios */ \"./lib/axios/index.js\");\n/* harmony import */ var _lib_axios__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_lib_axios__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! qs */ \"qs\");\n/* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(qs__WEBPACK_IMPORTED_MODULE_5__);\n/* harmony import */ var _Search__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Search */ \"./src/DataSources/SireneAPI/Search/index.js\");\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\n\n\n\n\n\nconst _ = {\n  axios: Symbol(\"_axios\"),\n  requestAPIs: Symbol(\"_requestAPIs\"),\n  getToken: Symbol(\"_getToken\")\n};\nclass SireneAPI extends _DataSource__WEBPACK_IMPORTED_MODULE_1__[\"default\"] {\n  constructor(baseURL, axiosConfig = {}) {\n    super();\n    this.token = null;\n    this.basicAuth = null;\n    this[_.axios] = _lib_axios__WEBPACK_IMPORTED_MODULE_4___default.a.create({\n      baseURL: baseURL,\n      timeout: 30000\n    });\n    this.axiosConfig = axiosConfig;\n  } // Etablissements\n\n\n  async getSIRET(SIRET) {\n    return await this[_.requestAPIs](SIRET, _Siret__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getSettlement);\n  } // Entreprises\n\n\n  async getSIREN(SIREN) {\n    return await this[_.requestAPIs](SIREN, _Siren__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getEntreprise, _Siret__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getSettlements);\n  }\n\n  async search(terms, page) {\n    const res = await Object(_Search__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(terms, page, this[_.axios], (await this.getAxiosConfig()), this.db);\n    return res;\n  }\n\n  async [_.requestAPIs](identifier, ...apiCalls) {\n    let out = {};\n    const requests = apiCalls.filter(fn => typeof fn === \"function\").map(async fn => {\n      return fn(identifier, this[_.axios], (await this.getAxiosConfig()), this.db);\n    });\n    await Promise.all(requests).then(results => {\n      Object.assign(out, ...results);\n    });\n    return out;\n  }\n\n  async getAxiosConfig() {\n    const axiosConfig = _objectSpread({}, this.axiosConfig, {\n      headers: {\n        Authorization: `Bearer ${await this[_.getToken](this.basicAuth)}`\n      }\n    });\n\n    if (axiosConfig.proxy && axiosConfig.proxy.tunnel === true) {\n      const agentConfig = {\n        proxy: {}\n      };\n\n      if (axiosConfig.proxy.host) {\n        agentConfig.proxy.host = axiosConfig.proxy.host;\n      }\n\n      if (axiosConfig.proxy.port) {\n        agentConfig.proxy.port = axiosConfig.proxy.port;\n      }\n\n      if (axiosConfig.proxy.auth) {\n        agentConfig.proxy.proxyAuth = `${axiosConfig.proxy.auth.username || \"\"}:${axiosConfig.proxy.auth.password || \"\"}`;\n      }\n\n      axiosConfig.proxy = false;\n      axiosConfig.httpsAgent = tunnel__WEBPACK_IMPORTED_MODULE_0___default.a.httpsOverHttp(agentConfig);\n    }\n\n    return axiosConfig;\n  }\n\n  async [_.getToken](basicAuth) {\n    const axiosConfig = _objectSpread({}, this.axiosConfig, {\n      headers: {\n        Authorization: `Basic ${basicAuth}`,\n        \"Content-Type\": \"application/x-www-form-urlencoded\"\n      }\n    });\n\n    try {\n      const request = await this[_.axios].post(\"https://api.insee.fr/token\", qs__WEBPACK_IMPORTED_MODULE_5___default.a.stringify({\n        grant_type: \"client_credentials\"\n      }), axiosConfig);\n      return request.data.access_token;\n    } catch (e) {\n      console.error(\"Request token failed\", e);\n      return null;\n    }\n  }\n\n}\n\n//# sourceURL=webpack://frentreprise/./src/DataSources/SireneAPI/SireneAPI.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../Utils/utils */ \"./src/Utils/utils.js\");\n/* harmony import */ var _Helpers_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/helpers */ \"./src/DataSources/SireneAPI/Helpers/helpers.js\");\n\n\n\nconst getSettlement = async (SIRET, Axios, params, db) => {\n  return await _Utils_utils__WEBPACK_IMPORTED_MODULE_0__[\"default\"].requestAPI(Axios, `siret/${SIRET}`, params).then(async data => {\n    if (!data.etablissement) {\n      return {};\n    }\n\n    return await _Helpers_helpers__WEBPACK_IMPORTED_MODULE_1__[\"default\"].formatEtab(data.etablissement, params, db);\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (getSettlement);\n\n//# sourceURL=webpack://frentreprise/./src/DataSources/SireneAPI/Siret/getSettlement.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../Utils/utils */ \"./src/Utils/utils.js\");\n/* harmony import */ var _Helpers_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/helpers */ \"./src/DataSources/SireneAPI/Helpers/helpers.js\");\n\n\n\nconst getSettlements = async (SIREN, Axios, params, db) => {\n  return await _Utils_utils__WEBPACK_IMPORTED_MODULE_0__[\"default\"].requestAPI(Axios, `siret/?q=siren:${SIREN}&nombre=10000`, params).then(async data => {\n    if (!data.etablissements) {\n      return {};\n    }\n\n    const etabs = await Promise.all(data.etablissements.map(async etab => await _Helpers_helpers__WEBPACK_IMPORTED_MODULE_1__[\"default\"].formatEtab(etab, params, db)));\n    return {\n      nombre_etablissements_actifs: etabs.filter(eta => eta.actif).length,\n      _ets: etabs\n    };\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (getSettlements);\n\n//# sourceURL=webpack://frentreprise/./src/DataSources/SireneAPI/Siret/getSettlements.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _getSettlement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getSettlement */ \"./src/DataSources/SireneAPI/Siret/getSettlement.js\");\n/* harmony import */ var _getSettlements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getSettlements */ \"./src/DataSources/SireneAPI/Siret/getSettlements.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  getSettlement: _getSettlement__WEBPACK_IMPORTED_MODULE_0__[\"default\"],\n  getSettlements: _getSettlements__WEBPACK_IMPORTED_MODULE_1__[\"default\"]\n});\n\n//# sourceURL=webpack://frentreprise/./src/DataSources/SireneAPI/Siret/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _SireneAPI__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SireneAPI */ \"./src/DataSources/SireneAPI/SireneAPI.js\");\n/* istanbul ignore file */\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (_SireneAPI__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n\n//# sourceURL=webpack://frentreprise/./src/DataSources/SireneAPI/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Naf; });\n/* harmony import */ var _Model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Model */ \"./src/Models/Model.js\");\n\nclass Naf extends _Model__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n  getByCode(code) {\n    return this.db.query(\"SELECT * FROM naf WHERE code = $1\", [code]).then(res => {\n      return res.rows && res.rows.length ? res.rows[0] : null;\n    }).catch(e => {\n      console.error(\"Naf::getByCode\", e);\n      return null;\n    });\n  }\n\n}\n\n//# sourceURL=webpack://frentreprise/./src/Models/Naf.js?");
