export default {
  ...
  formatEtab(etab) {
    ...
    return {
      ...
      libelle_naf: !etab.uniteLegale || this.isEmpty(etab.uniteLegale.activitePrincipaleUniteLegale) ? undefined : this.getNAF(etab.uniteLegale.activitePrincipaleUniteLegale.replace(".", "")),
      ...
      adresse_components: this.isEmpty(adresse_components) ? undefined : adresse_components,
      adresse: this.isEmpty(adresse_components) ? undefined : this.getCleanAddress(adresse_components),
